...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<AppException> cathExceptionGlobal(AppException exception, HttpServletRequest request) {
    ...
    public ResponseEntity<AppException> cathExceptionGlobal2(Exception exception, HttpServletRequest request) {
